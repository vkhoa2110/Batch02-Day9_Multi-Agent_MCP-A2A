...
def check_routing(state: State) -> list[Send]:
    ...
    question_lower = _normalize(state["question"])
    tasks = []
...
Hãy phân tích các vấn đề về privacy, data protection, quyền riêng tư,
nghĩa vụ thông báo khi data breach và rủi ro GDPR/luật bảo vệ dữ liệu cá nhân.
"""
